...
import onlineDoctorAppointmentSystemBackend.app.service.intf.AppointmentServiceIntf;
...
public class AppointmentServiceImpl implements AppointmentServiceIntf {
	...
	public String cancelAppointment(Long appointmentId) {
		...
		Appointment appointment = appointmentRepo.findById(appointmentId)
				.orElseThrow(() -> new ResourseNotFoundException("appointment Id not found"));
	...
	public List<LocalDateTime> bookAppointmentForPatient(Long doctorId, Long patientId, String stime) {
		...
		Doctor doctor = doctorRepo.findById(doctorId)
				.orElseThrow(() -> new ResourseNotFoundException("Doctor not found...!!!"));

		Patient patient = patientRepo.findById(patientId)
				.orElseThrow(() -> new ResourseNotFoundException("Patient not found...!!!"));
